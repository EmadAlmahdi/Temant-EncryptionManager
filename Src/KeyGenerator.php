...
final class KeyGenerator
{
     ...
     * @return KeyIvDTO A DTO containing 'key' and 'iv'.
     */
    public static function generateKeyIv(string $password, string $salt, int $ivLength): KeyIvDTO
    {
        $keyIv = hash_pbkdf2('sha256', $password, $salt, 10000, 64, true);

        return new KeyIvDTO(
            substr($keyIv, 0, 32),
            substr($keyIv, 32, $ivLength)
        );
    }
